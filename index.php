            ...
            <div class="col">
                <div class="carousel slide" id="dani-slideshow" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#dani-slideshow" data-slide-to="0"></li><!--data-slide-to="0"= indicas a que imagen debe enviarte, en este caso a la primera-->
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <!--elemento de tipo bloque= abarca el 100% del tamaño total que tiene-->
                            <img src="img/16.jpg" class="d-block w-100" alt="">     <!--d-block= display block y que cada una abarque 100%-->                                               
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="py-4 border-bottom"><!--py-4= padding en el eje de la y griega-->
                    <h1 class="text-center">Categorias</h1><!--text-center= centrar texto-->
                </div>
            </div>
        </div>
        <!-- <div class="row mt-3">
        ...
        <div class="row py-4"><!--py-4= padding en el eje de la y griega-->
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <div class="card"><!--card= tarjeta-->
                    <a href="paginacion/catalogo.php"><img class="card-img-top imagen" src="img/1.jpg" alt=""><!--card-img-top"= le decimos que tenemos una imagen en la parte superior de nuestra card-->
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <div class="card"><!--card= tarjeta-->
                    ...
                    <a href="paginacion/catalogo.php"><img class="card-img-top imagen" src="img/2.jpg" alt=""><!--card-img-top"= le decimos que tenemos una imagen en la parte superior de nuestra card--></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <div class="card"><!--card= tarjeta-->
                   ...
                   <a href="paginacion/catalogo.php"><img class="card-img-top imagen" src="img/3.jpg" alt=""><!--card-img-top"= le decimos que tenemos una imagen en la parte superior de nuestra card--></a>
                </div>
            </div>
